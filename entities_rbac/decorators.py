...
from entities_rbac.checkers import has_role, has_permission
from entities_rbac.utils import user_is_authenticated
...
def has_role_decorator(role, redirect_to_login=None):
    def request_decorator(dispatch):
        ...
        def wrapper(request, *args, **kwargs):
            ...
            if redirect is None:
                redirect = getattr(settings, "ENTITIES_RBAC_REDIRECT_TO_LOGIN", False)
            if redirect:
