...
class PermissionOverhiddenRedirectView(DetailView):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(PermissionOverhiddenRedirectView, self).dispatch(
            request, *args, **kwargs
        )
...
class RoleOverhiddenRedirectView(DetailView):
    ...
    def dispatch(self, request, *args, **kwargs):
        return super(RoleOverhiddenRedirectView, self).dispatch(
            request, *args, **kwargs
        )
...
@override_settings(
    ENTITIES_RBAC_REDIRECT_TO_LOGIN=True,
    LOGIN_URL="/login/",
...
@override_settings(
    ENTITIES_RBAC_REDIRECT_TO_LOGIN=False,
    LOGIN_URL="/login/",
    ROOT_URLCONF="tests.mock_urls",
)
