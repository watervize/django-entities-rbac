...
class UtilTests(TestCase):
    ...
    def test_camel_or_snake_to_title(self):
        self.assertEqual(
            camel_or_snake_to_title("snake_case_string"), "Snake Case String"
        )
        self.assertEqual(
            camel_or_snake_to_title("camelCaseString"), "Camel Case String"
        )
        self.assertEqual(
            camel_or_snake_to_title("mix_itUp_WhyNot"), "Mix It Up  Why Not"
        )
